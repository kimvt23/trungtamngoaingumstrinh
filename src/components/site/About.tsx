  ...
  return (
    <section id="about" className="py-20 lg:py-28">
      <div className="container-x grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div>
          <span className="text-sm font-bold uppercase tracking-[0.2em] text-foreground/60">About us</span>
          <h2 className="mt-4 font-display text-4xl sm:text-5xl font-extrabold leading-tight">
            A bright place to <span className="bg-secondary/60 px-2 rounded">grow your English</span>
          </h2>
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            We are a modern, friendly English center in Ba Ria & Vung Tau. For over 3 years
            we have helped kindergarteners, school students and adults speak English with
            confidence — through lively classes, dedicated teachers and a clear curriculum
            that parents trust and learners love.
          </p>

          <div className="mt-8 grid sm:grid-cols-3 gap-4">
            {[
              { icon: Heart, label: "Caring teachers" },
              { icon: Target, label: "Real results" },
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4 pt-12">
              <div className="rounded-3xl bg-secondary p-6 text-secondary-foreground shadow-glow">
                ...
                <div className="mt-2 text-sm font-medium opacity-90">Years of teaching</div>
              </div>
            ...
            <div className="space-y-4">
              <div className="rounded-3xl bg-card border border-border p-6 shadow-soft">
                ...
                <div className="mt-2 text-sm font-medium text-muted-foreground">Active students</div>
              </div>
              <div className="rounded-3xl bg-secondary/70 p-6 text-secondary-foreground shadow-soft">
                ...
                <div className="mt-2 text-sm font-medium opacity-90">Happy parents</div>
              </div>
            </div>
          </div>
        </div>
