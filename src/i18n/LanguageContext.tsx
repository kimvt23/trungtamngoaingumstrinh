...
const dict: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    "courses.detail": "Xem chi tiết",
    "courses.close": "Đóng",
    "courses.1.detail": "Khóa học IELTS giúp học viên phát triển toàn diện 4 kỹ năng: Nghe, Nói, Đọc, Viết. Giáo viên giàu kinh nghiệm sẽ hướng dẫn chi tiết từng dạng bài, chiến lược làm bài và cách đạt điểm cao. Học viên được luyện đề thường xuyên, sửa bài chi tiết và có thêm buổi học miễn phí hỗ trợ trước kỳ thi.",
    "courses.2.detail": "Khóa học tập trung vào giao tiếp thực tế trong cuộc sống và công việc. Học viên được thực hành phỏng vấn, viết email, thuyết trình và giao tiếp hàng ngày. Không chỉ học qua sách, học viên còn tham gia đóng vai tình huống thực tế để nâng cao phản xạ.",
    "courses.3.detail": "Chương trình luyện thi Cambridge giúp học viên nắm vững kiến thức và kỹ năng theo chuẩn quốc tế. Học viên được luyện đề, sửa bài chi tiết và làm quen với cấu trúc bài thi thực tế.",
    "courses.4.detail": "Chương trình dành cho trẻ mầm non, giúp bé làm quen với tiếng Anh một cách tự nhiên. Bé học thông qua trò chơi, hình ảnh, bài hát và hoạt động vận động, giúp phát triển phản xạ ngôn ngữ ngay từ nhỏ.",
    "courses.5.detail": "Học sinh được xây dựng nền tảng từ vựng, ngữ pháp và phát âm chuẩn. Các hoạt động học tập sinh động như trò chơi, đóng vai, thuyết trình giúp các em tự tin giao tiếp tiếng Anh.",
    "courses.6.detail": "Khóa học giúp học sinh phát triển kỹ năng học thuật và giao tiếp. Học viên được luyện nói, thuyết trình, phản biện và sử dụng tiếng Anh trong học tập và đời sống.",
    ...
    // IELTS CTA
    "ielts.cta.kicker": "Luyện thi IELTS",
    "ielts.cta.title": "Bộ đề luyện thi IELTS miễn phí",
    "ielts.cta.desc": "Trải nghiệm bài thi IELTS Listening & Reading đầy đủ 4 phần — kèm audio, đáp án và giải thích chi tiết. Hoàn toàn miễn phí.",
    "ielts.cta.btn": "Luyện thi IELTS miễn phí",
    "ielts.cta.start": "Bắt đầu luyện tập",
    "ielts.cta.listening.title": "IELTS Listening",
    "ielts.cta.listening.desc": "4 phần · audio + đáp án chi tiết",
    "ielts.cta.reading.title": "IELTS Reading",
    "ielts.cta.reading.desc": "Multiple choice · True/False · Matching",

    // General Benefits
    "gbenefits.kicker": "Lợi ích nổi bật",
    "gbenefits.title.main": "Lợi ích khi học tại",
    "gbenefits.title.accent": "trung tâm",
    "gbenefits.1": "Giáo viên tận tâm, giàu kinh nghiệm",
    "gbenefits.2": "Phát triển đầy đủ 4 kỹ năng: Nghe - Nói - Đọc - Viết",
    "gbenefits.3": "Phương pháp học hiện đại: học qua trò chơi, đóng vai, thuyết trình",
    "gbenefits.4": "Luyện tập thực tế: phỏng vấn, viết email, giao tiếp hàng ngày",
    "gbenefits.5": "Lớp học sinh động, tạo động lực cho học viên",
    "gbenefits.6": "Có các buổi ôn tập miễn phí trước kỳ thi ở trường",
    ...
    // Branches map
    "bmap.kicker": "Cơ sở",
    "bmap.title.main": "Địa chỉ các",
    "bmap.title.accent": "cơ sở",
    "bmap.desc": "Ghé thăm cơ sở gần bạn nhất — chúng tôi luôn sẵn sàng đón tiếp.",
    "bmap.maptitle": "Bản đồ",

    // Social
    "social.kicker": "Kết nối",
    "social.title.main": "Thông tin",
    "social.title.accent": "liên hệ",
    "social.desc": "Theo dõi chúng tôi trên mạng xã hội để cập nhật lớp học, mẹo học tiếng Anh và ưu đãi mới nhất.",

    // Netlify form
    "nlf.kicker": "Đăng ký",
    "nlf.title.main": "Gửi",
    "nlf.title.accent": "tin nhắn",
    "nlf.title.tail": "cho chúng tôi",
    "nlf.desc": "Để lại thông tin, đội ngũ trung tâm sẽ liên hệ với bạn sớm nhất.",
    "nlf.success": "Cảm ơn bạn! Chúng tôi sẽ liên hệ sớm.",
    "nlf.label.name": "Họ và tên",
    "nlf.label.phone": "Số điện thoại",
    "nlf.label.message": "Tin nhắn",
    "nlf.placeholder.name": "Nguyễn Văn A",
    "nlf.placeholder.message": "Tôi muốn đăng ký khóa học IELTS...",
    "nlf.send": "Gửi",
    "nlf.sending": "Đang gửi...",
    "nlf.error.required": "Vui lòng điền đầy đủ thông tin.",

    // Signup popup
    "popup.kicker": "Ưu đãi đặc biệt",
    "popup.title": "Đăng ký nhận tư vấn miễn phí",
    "popup.desc": "Để lại thông tin — giáo viên của chúng tôi sẽ liên hệ trong 24h để tư vấn lộ trình phù hợp.",
    "popup.label.name": "Họ và tên",
    "popup.label.phone": "Số điện thoại",
    "popup.label.course": "Khóa học quan tâm",
    "popup.placeholder.name": "Nguyễn Văn A",
    "popup.placeholder.course": "IELTS, Kids, Giao tiếp...",
    "popup.submit": "Đăng ký tư vấn",
    "popup.sending": "Đang gửi...",
    "popup.success": "Cảm ơn bạn! Trung tâm sẽ liên hệ sớm.",
    "popup.close": "Đóng",
    "popup.error.required": "Vui lòng điền đầy đủ thông tin.",
    "popup.privacy": "Thông tin của bạn được bảo mật tuyệt đối.",
  },
  en: {
    "nav.about": "About",
    "nav.courses": "Courses",
    ...
    "courses.close": "Close",
    "courses.1.detail": "Comprehensive IELTS training across all 4 skills: Listening, Speaking, Reading and Writing. Experienced teachers guide students through every question type, exam strategies and high-score techniques. Students take regular mock tests, get detailed feedback and bonus pre-exam sessions.",
    "courses.2.detail": "Focused on real-life and workplace communication. Students practise interviews, email writing, presentations and daily conversation through real-world role-plays.",
    "courses.3.detail": "Cambridge exam preparation following international standards. Students take mock tests with detailed feedback and become familiar with the real exam format.",
    "courses.4.detail": "A program for preschoolers that introduces English naturally through games, images, songs and movement activities — building language reflexes from an early age.",
    "courses.5.detail": "Students build a strong foundation of vocabulary, grammar and clear pronunciation through lively activities like games, role-plays and short presentations.",
    "courses.6.detail": "Students develop academic and communication skills — speaking, presenting, critical thinking and using English in real life and study.",
    "courses.1.title": "IELTS",
    "courses.1.tag": "General & Academic",
    ...
    "ielts.cta.kicker": "IELTS Practice",
    "ielts.cta.title": "Free IELTS Practice Tests",
    "ielts.cta.desc": "Try our complete 4-part IELTS Listening & Reading practice — with audio, answer keys and detailed explanations. Completely free.",
    "ielts.cta.btn": "Free IELTS Practice",
    "ielts.cta.start": "Start practicing",
    "ielts.cta.listening.title": "IELTS Listening",
    "ielts.cta.listening.desc": "4 parts · audio + detailed answer keys",
    "ielts.cta.reading.title": "IELTS Reading",
    "ielts.cta.reading.desc": "Multiple choice · True/False · Matching",

    "gbenefits.kicker": "Key benefits",
    "gbenefits.title.main": "Benefits of learning",
    "gbenefits.title.accent": "with us",
    "gbenefits.1": "Caring, experienced teachers",
    "gbenefits.2": "All 4 skills developed: Listening, Speaking, Reading, Writing",
    "gbenefits.3": "Modern methods: games, role-play and presentations",
    "gbenefits.4": "Real-life practice: interviews, emails and daily conversation",
    "gbenefits.5": "Lively classes that motivate students",
    "gbenefits.6": "Free review sessions before school exams",
    ...
    "bmap.kicker": "Branches",
    "bmap.title.main": "Our",
    "bmap.title.accent": "branch locations",
    "bmap.desc": "Visit the branch closest to you — we look forward to welcoming you.",
    "bmap.maptitle": "Map of",

    "social.kicker": "Connect",
    "social.title.main": "Contact",
    "social.title.accent": "information",
    "social.desc": "Follow us on social media for class updates, English learning tips and the latest offers.",

    "nlf.kicker": "Enroll",
    "nlf.title.main": "Send",
    "nlf.title.accent": "a message",
    "nlf.title.tail": "to us",
    "nlf.desc": "Leave your details and our team will reach out to you very soon.",
    "nlf.success": "Thank you! We will contact you soon.",
    "nlf.label.name": "Full name",
    "nlf.label.phone": "Phone number",
    "nlf.label.message": "Message",
    "nlf.placeholder.name": "Your name",
    "nlf.placeholder.message": "I'd like to enroll in the IELTS course...",
    "nlf.send": "Send",
    "nlf.sending": "Sending...",
    "nlf.error.required": "Please fill in all fields.",

    "popup.kicker": "Special offer",
    "popup.title": "Get a free consultation",
    "popup.desc": "Leave your details — our teachers will reach out within 24h with a personalised study plan.",
    "popup.label.name": "Full name",
    "popup.label.phone": "Phone number",
    "popup.label.course": "Course of interest",
    "popup.placeholder.name": "Your name",
    "popup.placeholder.course": "IELTS, Kids, Communication...",
    "popup.submit": "Request consultation",
    "popup.sending": "Sending...",
    "popup.success": "Thank you! We'll be in touch shortly.",
    "popup.close": "Close",
    "popup.error.required": "Please fill in all fields.",
    "popup.privacy": "Your information is kept strictly confidential.",
  },
};
